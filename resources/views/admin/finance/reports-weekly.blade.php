...
@section('page_title','Weekly Finance Report')
@section('page_subtitle','Revenue totals per week')
    ...
    <div class="col-12" data-aos="fade-up">
        <div class="card pd-card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    <div class="fw-bold">Weekly Revenue</div>
                    <div class="text-muted small">Sum of payments grouped by week</div>
                </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table align-middle">
                        ...
                        @forelse($rows as $r)
                            <tr>
                                <td class="fw-semibold">{{ $r->week ?? $r['week'] ?? '—' }}</td>
