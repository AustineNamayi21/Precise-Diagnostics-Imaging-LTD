...
@section('page_title','Monthly Finance Report')
@section('page_subtitle','Revenue totals per month')
    ...
    <div class="col-12" data-aos="fade-up">
        <div class="card pd-card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    <div class="fw-bold">Monthly Revenue</div>
                    <div class="text-muted small">Sum of payments grouped by month</div>
                </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table align-middle">
                        ...
                        @forelse($rows as $r)
                            <tr>
                                <td class="fw-semibold">{{ $r->month ?? $r['month'] ?? '—' }}</td>
