        ...
        <div class="card pd-card">
            <div class="card-header d-flex flex-wrap gap-2 justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('admin.imaging-services.show', ['imaging_service' => $imagingService->id]) }}"
            ...
            <div class="card-body">
                ...
                <form method="POST"
                      action="{{ route('admin.radiology-reports.store') }}"
                      enctype="multipart/form-data"
                      class="row g-3">
                    @csrf

                    <input type="hidden" name="imaging_service_id" value="{{ $imagingService->id }}">
